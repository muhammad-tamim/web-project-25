...
const AppointmentCard = ({ lawyer }) => {
    ...
    return (
        <div className='mb-[98px] border border-primary-content/15 rounded-2xl px-8 pt-8 pb-14'>
            ...
            <button onClick={() => handleBookAppointment(id)} className={`${todayAvailabilityCheck ? 'btn btn-success' : 'btn btn-error cursor-not-allowed'}  w-full rounded-full text-neutral-content font-bold md:text-xl mt-5 md:mt-[50px]`}>Book Appointment Now</button>
        </div >
    );
};
